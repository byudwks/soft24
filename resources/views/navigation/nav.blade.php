...
<body> 
        ...
        <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <button id="theme-toggle" type="button" class="me-3 text-zinc-900 dark:text-zinc-100 focus:outline-none rounded-lg text-md">
            ...
            @auth
                ...
                <!-- Dropdown menu -->
                <div class="z-50 hidden my-4 text-base list-none bg-zinc-100 dark:bg-zinc-700 rounded-lg shadow" id="user-dropdown">
                    <div class="px-4 py-3">
                    <span class="block text-sm text-zinc-950 dark:text-zinc-100">{{ auth()->user()->name }}</span>
                    <span class="block text-sm  text-zinc-950 dark:text-zinc-100 truncate">{{ auth()->user()->email }}</span>
                    </div>
                    <ul class="py-2" aria-labelledby="user-menu-button">
                    <li>
                        <a href="/admin" class="block px-4 py-2 text-sm text-zinc-950 dark:text-zinc-100">Dashboard</a>
                    </li>
                    </ul>
                </div>
    ...
    <footer class="bg-zinc-100 dark:bg-zinc-900 antialiased">
        <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
            <hr class="my-6 bg-zinc-400 sm:mx-auto dark:bg-amber-500 lg:my-8">
            <div class="text-center">
                <a href="#" class="flex justify-center items-center mb-5 text-2xl font-semibold text-zing-900 dark:text-amber-500">
                ...
                <span class="block text-sm text-center text-zing-900 dark:text-amber-500">© 2021-2022 <a href="#" class="hover:underline">Soft24™</a>. All Rights Reserved.
                </span>
            </div>
        </div>
    </footer>
